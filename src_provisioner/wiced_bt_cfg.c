...
wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_scan_cfg =                                                                                  // BLE scan settings
    {
        ...
        // .low_duty_conn_scan_interval     = 800,                                                      // Low duty cycle connection scan interval
    ...
    /* BLE advertisement settings */
    {
        ...
        .low_duty_max_interval           = 320,                                                     // Low duty undirected connectable maximum advertising interval
...
/*  { buf_size, buf_count } */
    ...
    { 200, 60 /* 30 */},      /* Medium Buffer Pool (used for HCI & RFCOMM control messages, min recommended size is 360) */
#else
    { 140, 40 },      /* Large Buffer Pool  (used for HCI ACL messages) */
#endif
    { 392, 16 },      /* Large Buffer Pool  (used for HCI ACL messages) */
